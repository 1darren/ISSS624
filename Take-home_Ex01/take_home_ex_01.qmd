...
sarb_sf <- st_read(dsn = "data/geospatial", 
                 layer = "singapore_administrative_region_boundaries") %>%
  st_transform(crs = 3414)
tmap_options(check.and.fix = TRUE)
qtm(sarb_sf)
## Additional data from: https://map.igismap.com/
```
...
weekday_morning_vis <- tm_shape(sarb_sf) +
  tm_polygons() + 
...
weekday_afternoon_vis <- tm_shape(sarb_sf) +
  tm_polygons() + 
  tm_shape(hexagon_sf_2) + 
...
weekend_morning_vis <- tm_shape(sarb_sf) +
  tm_polygons() + 
  tm_shape(hexagon_sf_2) + 
  tm_fill("WEEKEND_MORNING_TRIPS", 
          ...
          palette = "Reds",
          title = "Dependency ratio")
weekend_evenings_vis <- tm_shape(sarb_sf) +
  tm_polygons() + 
  tm_shape(hexagon_sf_2) + 
...
tmap_arrange(weekday_morning_vis, weekend_morning_vis,
             weekday_afternoon_vis, weekend_evenings_vis,
             nrow = 2, asp = 2)
```
...
weekday_morning_ss <- tm_shape(sarb_sf) +
  tm_polygons() + 
  tm_shape(hexagon_sf_2) + 
  tm_fill("WEEKDAY_MORNING_TRIPS", 
          style = "cont", 
          ...
          breaks = custom_breaks,
          title = "Dependency ratio")
weekday_afternoon_ss <- tm_shape(sarb_sf) +
  tm_polygons() + 
  tm_shape(hexagon_sf_2) + 
  tm_fill("WEEKDAY_AFTERNOON_TRIPS", 
          style = "cont", 
          ...
          breaks = custom_breaks,
          title = "Dependency ratio")
weekend_morning_ss <- tm_shape(sarb_sf) +
  tm_polygons() + 
  tm_shape(hexagon_sf_2) + 
  tm_fill("WEEKEND_MORNING_TRIPS", 
          style = "cont", 
          ...
          breaks = custom_breaks,
          title = "Dependency ratio")
weekend_evenings_ss <- tm_shape(sarb_sf) +
  tm_polygons() + 
  tm_shape(hexagon_sf_2) + 
  tm_fill("WEEKEND_EVENING_TRIPS", 
          style = "cont", 
...
tmap_arrange(weekday_morning_ss, weekend_morning_ss,
             weekday_afternoon_ss, weekend_evenings_ss,
             nrow = 2, asp = 2)
```
...
vis_faraway_hex <- tm_shape(sarb_sf) +
  tm_polygons() + 
...
local_moran_stats_sig <- tm_shape(sarb_sf) +
  tm_polygons() +
  tm_shape(hexagon_sf_local_moran) +
  tm_fill("darkgrey") +
