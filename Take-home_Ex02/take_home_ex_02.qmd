...
+-----------------------------------+----------------------------------------------------------------------------------+
| Shapefiles provided by Prof Kam:  | To provide estimation of density/number for use in spatial interaction modelling |
|                                   |                                                                                  |
| -   `Business`                    |                                                                                  |
|                                   |                                                                                  |
| -   `entertn`                     |                                                                                  |
...
| -   `Retails`                     |                                                                                  |
+-----------------------------------+----------------------------------------------------------------------------------+
| MRT Shapefiles, via LTA Datamall: | For analysis of MRT stations / MRT station exits in relation to bus flow traffic |
|                                   |                                                                                  |
| -   `RapidTransitSystemStation`   |                                                                                  |
|                                   |                                                                                  |
| -   `Train_Station_Exit_Layer`    |                                                                                  |
+-----------------------------------+----------------------------------------------------------------------------------+
